...
public interface QuestionnaireMapper {
	...
	@Insert(value = "{CALL SP_GA_UPDATE_QUESTIONS_DET_PV5(#{guid, mode=IN, jdbcType=BINARY},#{client_id, mode=IN, jdbcType=INTEGER}, #{audit_group_id, mode=IN, jdbcType=INTEGER},#{audit_type_id, mode=IN, jdbcType=INTEGER},"
